...
import { Heart, LayoutGrid, User, Calendar, Settings, MessageSquare, Stethoscope, Users } from "lucide-react";
import Link from "next/link";
import { usePathname } from "next/navigation";
import { COLORS } from "../../../Common/Colors"

const NAV_ITEMS = [
    { href: "/dashboards/doctordashboard", label: "Dashboard", icon: LayoutGrid },
    { href: "/Doctor/profile/profilepage", label: "Profile", icon: User },
            ...
            <aside
                ...
                <div className="flex  flex-col items-center gap-3  px-1">
                    ...
                    <div className="min-w-0">
                        <p className="text-sm font-medium truncate text-[#9DB0AB]" >{doctor.name}</p>
